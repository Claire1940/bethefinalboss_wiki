...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Be The Final Boss Wiki",
    description: "Read the Terms of Service for Be The Final Boss Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Be The Final Boss Wiki",
      description: "Terms and conditions for using Be The Final Boss Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Be The Final Boss Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Be The Final Boss Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Be The Final Boss Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Be The Final Boss Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Be The Final Boss". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Working codes, rewards, and redemption guides</li>
              <li>Minion guides, lineups, and tier lists</li>
              <li>Weapon unlock and upgrade walkthroughs</li>
              <li>Skill tree builds and upgrade orders</li>
              <li>Endless wave and defense strategy guides</li>
              <li>Currency (Souls, Coins) tips and community content</li>
            </ul>
            <p>
              <strong>Important:</strong> Be The Final Boss Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the game's developer, Apparently Champions. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Be The Final Boss Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Be The Final Boss. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Game updates, content changes, and code availability may occur without notice. We are not responsible for game changes or content availability.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BE THE FINAL BOSS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Be The Final Boss Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@bethefinalboss.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@bethefinalboss.wiki</a>
            </p>
            <p>
